<x-layouts.dashboard.admin>
    <div class="p-4 xl:ml-64 h-full">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 box-border grid md:grid-cols-2 md:grid-rows-2 gap-4 mb-4 place-items-center w-full">
