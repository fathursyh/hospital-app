<section id="features" class="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6">
    ...
    <div class="space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:grid-cols-3">
        ...
        <div class="rounded-lg bg-white p-6 shadow-lg transition-shadow hover:shadow-xl" data-aos="fade-up" data-aos-delay="0">
            ...
            <h3 class="mb-2 text-xl font-bold">Patient Management</h3>
            <p class="text-gray-500">Complete patient records, medical history, and real-time health monitoring in
        ...
        <div class="rounded-lg bg-white p-6 shadow-lg transition-shadow hover:shadow-xl" data-aos="fade-up" data-aos-delay="100">
            ...
            <h3 class="mb-2 text-xl font-bold">Appointment Scheduling</h3>
            <p class="text-gray-500">Smart scheduling system that optimizes doctor availability and reduces patient
                wait times.</p>
        </div>
        <!-- Feature 3 -->
        <div class="rounded-lg bg-white p-6 shadow-lg transition-shadow hover:shadow-xl" data-aos="fade-up" data-aos-delay="200">
            ...
            <p class="text-gray-500">Track medical supplies, medications, and equipment with automated reorder
                alerts.</p>
        </div>
        <!-- Feature 4 -->
        <div class="rounded-lg bg-white p-6 shadow-lg transition-shadow hover:shadow-xl" data-aos="fade-up" data-aos-delay="300">
            ...
            <h3 class="mb-2 text-xl font-bold">Analytics & Reports</h3>
            <p class="text-gray-500">Comprehensive insights into hospital operations, patient outcomes, and
        ...
        <div class="rounded-lg bg-white p-6 shadow-lg transition-shadow hover:shadow-xl" data-aos="fade-up" data-aos-delay="400">
            ...
            <h3 class="mb-2 text-xl font-bold">HIPAA Compliant</h3>
            <p class="text-gray-500">Bank-level security with end-to-end encryption to protect sensitive patient
                data.</p>
        </div>
        <!-- Feature 6 -->
        <div class="rounded-lg bg-white p-6 shadow-lg transition-shadow hover:shadow-xl" data-aos="fade-up" data-aos-delay="500">
            ...
            <h3 class="mb-2 text-xl font-bold">Mobile Access</h3>
            <p class="text-gray-500">Access critical information anywhere with our responsive mobile-first design.
            </p>
        </div>
    </div>
</section>
