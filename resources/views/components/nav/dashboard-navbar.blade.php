    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-200 dark:bg-gray-800">
       ...
       <ul class="space-y-2 font-medium mt-4">
         <x-theme />
          ...
          <li>
             <a href="{{ route('dashboard-appointments') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
