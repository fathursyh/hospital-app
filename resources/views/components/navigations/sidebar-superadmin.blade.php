@php
    function activeLink($pattern)
    {
        return request()->is($pattern) ? 'bg-gray-700' : null;
    }
@endphp
        ...
        <ul class="space-y-2">
            <li class="mb-4">
                <a href="/"
                    ...
                    <svg class="h-6 w-6 text-gray-800 dark:text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                        viewBox="0 0 24 24">
            ...
            <li>
                <a href="{{ route('superadmin.hospitals') }}"
                    ...
                    <svg class="h-6 w-6 flex-shrink-0 text-gray-400 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        fill="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <a href="{{ route('superadmin.plans') }}"
                    class="{{ activeLink('superadmin/dashboard/plans') }} group flex items-center rounded-lg p-2 text-base font-normal text-gray-900 transition duration-75 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                    <svg class="h-6 w-6 flex-shrink-0 text-gray-400 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                         xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        fill="currentColor" viewBox="0 0 24 24">
                        <path
        ...
        <ul class="mt-5 space-y-2 border-t border-gray-200 pt-5 dark:border-gray-700">
            ...
            <li>
                <a href="/logout"
                    ...
                    <svg class="h-6 w-6 text-gray-800 dark:text-red-500"
