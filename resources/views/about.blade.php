        ...
        <div class="mt-18 w-screen">
            <div class="container max-w-screen-xl mx-auto my-10 px-4">
                <section class="bg-white dark:bg-zinc-900 shadow-md rounded-lg p-6">
                    ...
                    <p class="mt-4">
                        At F-Hospital, we are committed to providing exceptional healthcare services to our community. Our team of dedicated professionals works tirelessly to ensure that every patient receives the highest quality of care in a compassionate and respectful environment.
                    </p>
                    <p class="mt-4">
                        Established in 2020, our hospital has grown to become a leading healthcare provider in the region. We offer a wide range of medical services, including emergency care, surgery, maternity, and specialized treatments, all designed to meet the diverse needs of our patients.
                    </p>
                    <p class="mt-4">
