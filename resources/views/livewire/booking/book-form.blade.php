<form class="xl:w-1/3 mx-auto">
    <h3 class="text-center text-xl font-bold font-roboto text-gray-700 dark:text-gray-300 mb-6">Book New Appointment.
    </h3>
    ...
    <div class="relative z-0 w-full mb-5 group">
        ...
        <div class="relative max-w-sm mb-5 group">
            ...
            <input datepicker datepicker-autohide datepicker-min-date="today" datepicker-max-date="today + 60"
                id="default-datepicker" type="text" name="date"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 placeholder-gray-600"
                placeholder="Select date">
        </div>
        {{-- GENDER --}}
        <div class="relative z-0 w-full mb-5 group">
            <div class="flex items-center mb-4">
                <input checked id="gender-1" type="radio" value="M" name="gender"
            ...
            <div class="flex items-center">
                <input id="gender-2" type="radio" value="W" name="gender"
                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
        ...
        <div class="relative z-0 w-full mb-5 group">
            ...
            <label for="message" class="block mb-2 text-sm text-sm text-gray-700 dark:text-gray-400">Reason of appointment</label>
