<div class="relative max-w-screen-xl overflow-x-auto space-y-4">
            ...
            <tbody>
                @foreach ($this->appointmentData() as $appointment)
                    <tr class="border-b bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">
                            <span
                                class="px-2 py-1 rounded capitalize @if ($appointment->status === 'scheduled') bg-blue-800
                            @elseif($appointment->status === 'completed')
                                bg-green-800
                                @else
                                bg-red-800 @endif text-white">{{ $appointment->status }}</span>
                        </td>
